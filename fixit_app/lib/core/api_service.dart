...
class ApiService {
  final String baseUrl = "http://192.168.137.193:8000/api";
  final Dio dio;
  ...
  ApiService()
      : dio = Dio(
          BaseOptions(
            baseUrl: "http://192.168.137.193:8000/api",
  ...
  Future<String?> _getStoredAccessToken() async {
    if (_cachedAccessToken != null && _cachedAccessToken!.isNotEmpty) {
      dio.options.headers['Authorization'] = 'Bearer $_cachedAccessToken';
    ...
    if (kIsWeb) {
      ...
      access = await _secureStorage.read(key: 'access_token');
    }
  ...
  Future<void> clearTokens() async {
    try {
      ...
      print("🧹 Tokens cleared and Dio headers reset.");
    } catch (e) {
