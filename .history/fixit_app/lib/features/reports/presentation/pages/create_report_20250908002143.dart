                        ...
                        onPressed: () {
                          if (_createReportKey.currentState!.validate()) {
                            final reportData = {
                              ...
                              'date': context.read<ReportViewModel>().formattedDate,
                              'time': context.read<ReportViewModel>().formattedTime,
                              'visibility': _selectedOption ?? '',
                              'image': context.read<ReportViewModel>().selectedImage?.path ?? '',
                              'status': '',
                              'statusColor': '',
                              'like': 0,
                            };
                            Navigator.of(
                              context).push(MaterialPageRoute(
                                builder: (context) => const HomePage(report: reportData),
                              ),
                            );
                          }
                        },
