          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Date
                Consumer<ReportViewModel>( builder: (context, vm, child) { return TextFormField( readOnly: true, controller: TextEditingController( text: vm.formattedDate, ), decoration: inputDecoration("Enter Date").copyWith( suffixIcon: IconButton( onPressed: () => vm.pickDate(context), icon: const Icon(Icons.calendar_month), color: Colors.black, ),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
