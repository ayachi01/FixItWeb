              ...
              children: [
                ...
                Consumer<ReportViewModel>( 
                  builder: (context, vm, child) { 
                    ...
                    decoration: inputDecoration("Enter Date").copyWith( suffixIcon: IconButton( onPressed: () => vm.pickDate(context), icon: const Icon(Icons.calendar_month), color: Colors.black, ),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
