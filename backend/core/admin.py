...
from .models import UserProfile, Invite, Location, Ticket, GuestReport, TicketImage, TicketResolution, TicketActionLog, Notification, AuditLog

@admin.register(UserProfile)
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'role', 'is_email_verified', 'email_domain')
    search_fields = ('user__username', 'role', 'email_domain')
...
class NotificationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('message', 'user__username', 'guest_email')
