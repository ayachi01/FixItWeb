# Generated by Django 5.2.6 on 2025-10-07 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invites', to='core.role')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='core.role')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='domain_mappings', to='core.role')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Created', 'Created'), ('Assigned', 'Assigned'), ('In Progress', 'In Progress'), ('Needs Assistance', 'Needs Assistance'), ('Resolved', 'Resolved'), ('Closed', 'Closed'), ('Reopened', 'Reopened'), ('Cancelled', 'Cancelled')], db_index=True, default='Created', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('student_id', models.CharField(db_index=True, max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Student ID must be in the format NN-NNNN-NNNNNN (e.g., 09-3456-348946)', regex='^\\d{2}-\\d{4}-\\d{6}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code_hash', models.CharField(blank=True, db_index=True, max_length=128)),
                ('created_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
            ...
            options={
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_used', False)), fields=('user', 'is_used'), name='unique_active_reset_code_per_user')],
            },
        ),
        ...
        migrations.AddIndex(
            model_name='ticket',
            index=models.Index(fields=['title'], name='core_ticket_title_ed252f_idx'),
        ),
        migrations.AddConstraint(
            model_name='ticket',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['role'], name='core_userpr_role_id_3d2d29_idx'),
        ),
        migrations.AddIndex(
            model_name='studentprofile',
            index=models.Index(fields=['student_id'], name='core_studen_student_753897_idx'),
        ),
        migrations.AddIndex(
            model_name='studentprofile',
            index=models.Index(fields=['course_code'], name='core_studen_course__0febf5_idx'),
        ),
        migrations.AddIndex(
            model_name='studentprofile',
            index=models.Index(fields=['year_level'], name='core_studen_year_le_3b539b_idx'),
        ),
    ]
